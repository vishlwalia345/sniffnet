...
use crate::countries::flags_emojis::{
    ...
    // ET, FI, FJ, FK,
    FLAGS_WIDTH_BIG, FLAGS_WIDTH_SMALL,
    ...
    // UG, UNKNOWN,
    US,
    // UY, UZ, VA, VC, VE, VG, VI, VN, VU, WS, YE, ZA, ZM, ZW,
};
...
use crate::gui::styles::style_constants::EMOJY;
...
fn get_flag_from_country(
    ...
    language: Language,
) -> (Text<'static, Renderer<StyleType>>, String) {
    #![allow(clippy::too_many_lines)]
    let mut tooltip = country.to_string();
    let emoji = Text::new(match country {
        // Country::AD => AD,
        // Country::AE => AE,
        // Country::AF => AF,
        // Country::AG => AG,
