...
use crate::gui::styles::style_constants::{EMOJY_BYTES, get_font, get_font_headers, ICONS_BYTES, SARASA_MONO_BOLD_BYTES, SARASA_MONO_BYTES};
    ...
    fn new(flags: Sniffer) -> (Sniffer, Command<Message>) {
        (
            ...
            Command::batch(vec![
                ...
                font::load(EMOJY_BYTES).map(Message::FontLoaded),
            ]),
        )
    }
